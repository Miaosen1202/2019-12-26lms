<template>
    <div>
        <el-button
            v-if="isPdf"
            type="primary"
            style="position: absolute;top: 7%;right: 30px;"
            @click="linkDownload()"
        >
            Fullscreen
        </el-button>
        <div v-if="isPdf">
            <!--<p class="arrow">
                <el-button type="primary" @click="changePdfPage(0)"
                 :disabled="currentPage==1" size="mini">Prev
                </el-button>
                &lt;!&ndash; <span @click="changePdfPage(0)"
                class="turn" :class="{grey: currentPage==1}">Preview</span> &ndash;&gt;
                <span style="display:inline-block;margin: 0
                10px">{{currentPage}} / {{pageCount}}</span>
                &lt;!&ndash; <span @click="changePdfPage(1)"
                class="turn" :class="{grey: currentPage==pageCount}">Next</span> &ndash;&gt;
                <el-button type="primary" @click="changePdfPage(1)"
                 :disabled="currentPage==pageCount" size="mini">
                    Next
                </el-button>
            </p>
            <pdf
        ...
        <div v-if="isUnsupport" class="promptText">
