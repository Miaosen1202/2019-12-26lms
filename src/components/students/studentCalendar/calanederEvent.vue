        ...
        <div class="calendar-contain">
            ...
            <div class="calendar-contain-left">
                ...
                >
                    ...
                    <el-breadcrumb-item :to="{ path: 'studentCalendarWatch' }">
    ...
    methods: {
        initFomrData() {
            ...
            if (this.eventType == "create") {
                this.initMoreEventObj = JSON.parse(
                    localStorage.getItem("createStudentEventObj")
                );
                Object.assign(
                    this.moreEventForm,
                    JSON.parse(localStorage.getItem("createStudentEventObj"))
                );
                ...
                if (this.moreEventForm.calendarType == 2) {
                    ...
                    let tempCourseId = this.moreEventForm.courseId;
                }
            } else if (this.eventType == "edit") {
                this.initMoreEventObj = JSON.parse(
                    localStorage.getItem("editStudentEventObj")
                );
                if (this.initMoreEventObj.startTime != "") {
                    this.$set(
                        this.moreEventForm,
                ...
                Object.assign(
                    this.moreEventForm,
                    JSON.parse(localStorage.getItem("editStudentEventObj"))
                );
        ...
        initTime(formName) {
            ...
            if (this[formName].date) {
                let tempYear = this.moreEventForm.date.getFullYear();
                let tempMonth = this.moreEventForm.date.getMonth();
                let tempDay = this.moreEventForm.date.getDate();
                let tempStartHours = new Date(
                    this.moreEventForm.eventTimeVal[0]
                ).getHours();
                let tempStartMinutes = new Date(
                    this.moreEventForm.eventTimeVal[0]
                ).getMinutes();
                let tempEndHours = new Date(
                    this.moreEventForm.eventTimeVal[1]
                ).getHours();
                let tempEndMinutes = new Date(
                    this.moreEventForm.eventTimeVal[1]
                ).getMinutes();
        ...
        async createEvent(formName) {
            this.$refs[formName].validate(async valid => {
                ...
                if (result.data.code == 200) {
                    ...
                    localStorage.removeItem("createStudentEventObj");
                    this.$router.push({ path: "studentCalendarWatch" });
                }
            });
        },
        ...
        async updateEvent(formName) {
            this.$refs[formName].validate(async valid => {
                ...
                if (result.data.code == 200) {
                    ...
                    localStorage.removeItem("editStudentEventObj");
                    this.$router.push({ path: "studentCalendarWatch" });
                }
            });
        },
