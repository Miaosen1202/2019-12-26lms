            ...
            <el-row>
                ...
                <el-col :span="12">
                    <div style="float: right;margin-right: 17%">
                        <!--<el-button type="primary" @click="addDiscussion" icon="el-icon-circle-plus-outline"-->
                        <!---->
                        <!--style="display: inline-block;width: 100%" >Discussion-->
                        <!--</el-button>-->
                        <el-button
                            v-if="allowStudentCreateDiscussion == 1"
                            type="primary"
                        ...
                        <div class="disMain">
                            <div class="disMainImg">
                                ...
                                <a
                                    ...
                                    >{{
                                        $t(
                                            "message.Click_here_to_add_a_discussion"
                                        )
                                    }}</a
                                >
                            </div>
                      ...
                      overflow: hidden;text-overflow:ellipsis;white-space: nowrap"
                                ...
                                <el-table-column label="" min-width="135">
                                    <template slot-scope="scope">
                                        ...
                                        <el-dropdown v-if="!hasNoOpPermission">
                                            <div
    ...
    methods: {
        ...
        hasNoOpPermission() {
            return (
                ...
                this.userInfoData.id != this.createUserId &&
                this.allowStudentEditDiscussion == 1
            );
            ...
            this.$router.push({
                ...
                query: {
                    allowStudentCreateDiscussion: this
                        .allowStudentCreateDiscussion,
                    allowStudentEditDiscussion: this.allowStudentEditDiscussion,
